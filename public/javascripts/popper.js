  ...
  function mapToStyles (_ref2) {
    ...
    if (adaptive) {
      ...
      if (placement === top || (placement === left || placement === right) && variation === end) {
        sideY = bottom
        const offsetY = isFixed && win.visualViewport ? win.visualViewport.height // $FlowFixMe[prop-missing]
      ...
      if (placement === left || (placement === top || placement === bottom) && variation === end) {
        sideX = right
        const offsetX = isFixed && win.visualViewport ? win.visualViewport.width // $FlowFixMe[prop-missing]
